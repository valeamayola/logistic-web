...
export default function CardServicesRight({ id, img, title, description }: CardServicesProps) {
    return (
        <div id={id} className="card card-side w-full bg-slate-800 shadow-xl flex flex-col md:flex-row m-2 md:m-5">
