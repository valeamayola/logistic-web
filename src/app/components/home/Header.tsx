...
export default function Header() {
    ...
    return (
        <header className="px-5 md:px-16 py-10 md:py-28 flex items-start justify-start flex-col">
            ...
            <Link href="/" className="btn bg-orange-700 text-lg font-semibold mt-10 text-white border-none rounded-2xl hover:bg-white hover:text-orange-600">Ver servicios</Link>
        </header>
    )
}
